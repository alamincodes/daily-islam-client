...
const Info = () => {
    return (
        <div className='grid md:grid-cols-3 md:gap-3 sm:gap-2 sm:grid-cols-1 md:my-26 sm:my-10'>
            <InfoCards title="নামাজের দোয়া" img={namajSvg} bg="bg-gradient-to-t from-[#f3696e] to-[#f8a902]" />
