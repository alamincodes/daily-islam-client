...
const footer = () => {
  return (
    <div>
      <footer className="bg-white bg-opacity-20 backdrop-blur-lg drop-shadow-lg md:rounded-t-[50px] sm:rounded-t-[20px] mt-[150px]">
        <div className="max-w-5xl px-4 py-10 mx-auto sm:px-6 lg:px-8">
          <div className="flex justify-center items-center flex-col">
            <div className="select-none text-white mt-5 bg-black px-5 rounded-lg">
