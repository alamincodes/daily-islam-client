  ...
  return (
    <div>
      ...
      <div className=" flex justify-between items-center shadow-[0_3px_10px_rgb(0,0,0,0.1)] md:py-3 py-5 ">
        <div className="flex flex-col md:w-auto sm:w-[130px] items-center border-l-4 border-r-4 border-r-[#FF284F] border-l-[#FF284F] md:mx-5 sm:mx-1 px-3">
          <h4 className="md:text-3xl sm:text-[20px] font-bold">সময়</h4>
          <h2 className=" md:text-4xl sm:text-[17px] font-semibold md:tracking-[0.5rem] sm:tracking-[1px]">
            {currentTime}
          </h2>
        </div>
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 lg:gap-4 md:gap-4 gap-3 my-5">
        {cards.map((card) => (
          <div key={card.id}>
            ...
            <div>
              <div className="flex lg:flex-row md:flex-row sm:flex-col justify-center items-center shadow-[0_3px_10px_rgb(0,0,0,0.1)] py-5 px-2 transform hover:scale-95 duration-500 hover:bg-gray-100">
                {" "}
