...
const Cards = () => {
  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-3 grid-cols-2 gap-3 my-5">
        {cards.map((card) => (
          <Link to={card.linkPage}>
          <div key={card.img}>
            <div className="flex  lg:flex-row md:flex-row flex-col justify-center items-center shadow-[0_3px_10px_rgb(0,0,0,0.1)] py-5 px-2 transform hover:scale-105 duration-500">              <h2 className="lg:text-3xl md:text-2xl text-1xl">{card.name}</h2>
